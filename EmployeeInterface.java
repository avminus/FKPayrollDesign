...
class HourlyEmployee implements EmployeeInterface{
		...
		HourlyEmployee(int IDnum,double hourlyrate, MOP valueMOP, double normalhour, double overtimehour, UnionInterface unionobj){
...
class MonthlyEmployee implements EmployeeInterface{
	...
	MonthlyEmployee(int IDnum, double monthlysalary, MOP valueMOP, double comissionrate, double accruedsales, UnionInterface unionobj){
